      ...
      <div className="viewport">
        <div className="all">
          ...
          <div className="scroll">
            ...
            <div className="projects ui">
              ...
              <div className="projects-section">
                ...
                <p className="projects-text">
                  small text ghfvghjkv fghjfg kj jhglhj gnm hjg jhklg k
                  gjhlglmhj gjkh jlkmh njl. h fkfghj ghj hjl hjghjl hjlg mbhnmb
                  ,mn jhjklhg hjk khjjk l.m,n.jk.h jkmjn .jkh knhhjk. h; nm,b
                  uk;h
                </p>
            ...
            <div className="projects ui">
              <div className="img-p-section">
                <img className="p-img" src="/assets/img/nela-img.png" alt="" />
                <p>06.2025</p>
              </div>
              <div className="projects-section">
                <div className="projects-title">
            ...
            <div className="projects gd">
              <div className="img-p-section">
                <img className="p-img" src="/assets/img/satine-01.png" alt="" />
                <p>04.2025</p>
              </div>
              <div className="projects-section">
                <div className="projects-title">
            ...
            <div className="projects cd">
              <div className="img-p-section">
                <img className="p-img" src="/assets/img/png-tuber.png" alt="" />
                <p>04.2025</p>
              </div>
              <div className="projects-section">
                <div className="projects-title">
            ...
            <div className="projects gd">
              <div className="img-p-section">
                <img className="p-img" src="/assets/img/miku-01.png" alt="" />
                <p>10.2024</p>
              </div>
              <div className="projects-section">
                <div className="projects-title">
            ...
            <div className="projects cd">
              <div className="img-p-section">
                <img className="p-img" src="/assets/img/character.png" alt="" />
                <p>10.2024</p>
              </div>
              <div className="projects-section">
                <div className="projects-title">
